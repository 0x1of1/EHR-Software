...
if (!defined('APP_NAME')) {
    define('APP_NAME', '1of1Group');
}
if (!defined('FB_URL')) {
    define('FB_URL', 'https://www.facebook.com/1of1Group');
};
if (!defined('TWITTER_URL')) {
    define('TWITTER_URL', 'https://twitter.com/1of1Group');
};
...
if (!defined('CONTACT_EMAIL')) {
    define('CONTACT_EMAIL', 'info@1of1group.com');
}
if (!defined('KEY_PREFIX')) {
    define('KEY_PREFIX', '1of1Group');
}
...
define('ALL_CLIENT_BASE_PATH', '/var/www/1of1group.app/1of1groupapp/');
